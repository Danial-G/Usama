...
class CartPage extends StatelessWidget {
  ...
  return Card(
    ...
    child: Padding(
      padding: const EdgeInsets.all(8.0), // Add consistent padding inside the card
      child: Row(
        ...
        children: [
          ClipRRect(
            ...
            child: Image.asset(
              imageUrl,
              height: 100, // Optional: Define a fixed height for the image
              width: 100, // Optional: Define a fixed width for the image
              fit: BoxFit.cover,
            ),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              mainAxisSize: MainAxisSize.min, // Ensures the height fits content
              children: [
                Text(
                  title,
                ...
                SizedBox(height: 8), // Add space between subtitle and price
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(
